--enjoy?
    ...
    rconsoleclear()
    rconsolename("Skywars Cracked Script")
    rconsoleprint('@@BLUE@@')
	...
	MainStuffSection:NewButton("Fling Everyone [skidded + doesnt work lmao]","Stop open that" , function()
		local Why      = game:GetService("Players").LocalPlayer
...
MainStuffSection:NewToggle("AutoToxic(English)","Stop open that" , function(v)
	...
	MineSection:NewButton("MineboxV3","Uwu" , function()
	...
	local InfoSection = Info:NewSection("Script by Aro [:vomit: buy synapse]")
	local InfoSection = Info:NewSection("Roblox user:roblox")
	local InfoSection = Info:NewSection("Discord: buy synapse ")
